...
export declare class RevalidateResponse {
    isValid: boolean;
...
export declare class CharacterLimit {
    firstName: string;
    lastName: string;
    paxName: string;
}
export declare class RevalidateData {
...
export declare class FareRules {
    origin?: string;
    Destination?: string;
    Airline?: string;
...
export declare class CancellationFareRule {
    trackingId: string;
    fareRules: {
        destination: string;
        origin: string;
