...
const provider_revalidate_service_1 = require("../providers/provider-revalidate.service");
let RevalidateService = class RevalidateService {
    providerRevalidateService;
    constructor(providerRevalidateService) {
        this.providerRevalidateService = providerRevalidateService;
    }
...
exports.RevalidateService = RevalidateService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [provider_revalidate_service_1.ProviderRevalidateService])
], RevalidateService);
