...
exports.RoomModule = RoomModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [room_service_1.HotelRoomService, supplier_cred_service_1.SupplierCredService],
        controllers: [room_controller_1.HotelRoomController],
        exports: [room_service_1.HotelRoomService]
    })
], RoomModule);
