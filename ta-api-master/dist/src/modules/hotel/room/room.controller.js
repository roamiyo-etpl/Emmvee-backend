...
exports.HotelRoomController = void 0;
...
const hotel_room_list_dto_1 = require("./dtos/hotel-room-list.dto");
const hotel_room_quote_dto_1 = require("./dtos/hotel-room-quote.dto");
let HotelRoomController = class HotelRoomController {
    roomService;
    constructor(roomService) {
        this.roomService = roomService;
    }
    async getRoomList(hotelRoomListRequestDto, headers) {
        return await this.roomService.getHotelRoomList(hotelRoomListRequestDto, headers);
    }
    async getRoomQuote(hotelRoomQuotedto, headers) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [hotel_room_list_dto_1.HotelRoomListRequestDto, Object]),
    __metadata("design:returntype", Promise)
], HotelRoomController.prototype, "getRoomList", null);
__decorate([
    (0, swagger_1.ApiOperation)({
    ...
    __param(1, (0, common_1.Headers)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [hotel_room_quote_dto_1.HotelRoomQuoteDto, Object]),
    __metadata("design:returntype", Promise)
], HotelRoomController.prototype, "getRoomQuote", null);
exports.HotelRoomController = HotelRoomController = __decorate([
    ...
    (0, common_1.Controller)('hotel/room'),
    __metadata("design:paramtypes", [room_service_1.HotelRoomService])
], HotelRoomController);
